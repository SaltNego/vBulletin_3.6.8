...
{
// vB ޸Ŀʼ: 
	echo '<div>vBulletin ݻ󣬿ԭ:
		<ol>
			' . (function_exists('mmcache_get') ? '<li>Turck MMCache װķУȳԽ Turck MMCache 滻Ϊ eAccelerator</li>' : '') . '
			<li>ϴ vBulletin 3.6 ļû vBulletin ûôС</li>
			<li>Datastore ܳ��� <em>tools.php</em>  <em>ؽ Bitfields</em> vBulletin  <em>do_not_upload</em> Ŀ¼ҵļ</li>
		</ol>
	</div>';

	trigger_error('vBulletin datastore ʧЧ', E_USER_ERROR);
// vB ޸Ľ
}
