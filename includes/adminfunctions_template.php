...
function build_all_styles($renumber = 0, $install = 0, $goto = '')
{
	...
	$phrases = array(
		...
		'controls' => '控制',
		'rebuild_style_information' => '重建风格信息',
		'updating_style_information_for_each_style' => '正在为每个风格更新风格信息',
		'updating_styles_with_no_parents' => '正在更新无父风格信息的风格集',
		'updated_x_styles' => '已更新 %1$s 个风格',
		'no_styles_needed_updating' => '没有风格需要更新',
	);
