...
*
* @package 		vBulletin
* @version		$Revision: 17021 $
* @date 		$Date: 2007-05-16 05:23:46 -0500 (Wed, 16 May 2007) $
*
*/
...
class vB_Postbit_Post extends vB_Postbit
{
	...
	*/
	function process_highlight_postbit($text, $words, $prepend)
	{
		...
		{
// vB 中文修改开始：中文搜索 高亮显示
			$text = str_replace($replaceword,  '<vb_highlight>'. $replaceword .'</vb_highlight>', $text);
// vB 中文修改结束
		}
