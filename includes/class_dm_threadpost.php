...
// vB ޸Ŀʼ: ȫ
		if ($this->registry->options['fulltextsearch'])
		{
			$this->set('titleindex', implode(' ', sp_str($this->post['title'])));
			$this->set('pagetextindex', implode(' ', sp_str($this->post['pagetext'])));
		}
// vB ޸Ľ
		return true;
	}
...
// vB ޸Ŀʼ: ȫ
		'titleindex'    => array(TYPE_STR,  REQ_NO),
		'pagetextindex' => array(TYPE_STR,  REQ_NO),
// vB ޸Ľ
...
// vB ޸Ŀʼ: ȫ
		if ($this->thread['title'] AND $this->registry->options['fulltextsearch'])
		{
			$this->set('titleindex', implode(' ', sp_str($this->thread['title'])));
		}
// vB ޸Ľ
