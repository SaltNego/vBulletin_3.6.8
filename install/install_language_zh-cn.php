...
$vbphrase['proceed'] = '继续';
$vbphrase['reset'] = '重置';
$vbphrase['vbulletin_copyright'] = 'vBulletin v' . VERSION . ', 版权所有 &copy;2000 - 2007, Jelsoft Enterprises Ltd.';
...
$install_phrases['welcome'] = '<p style="font-size:10pt"><b>欢迎使用 vBulletin 3.6 中文版</b></p>
	<p>您即将开始安装本程序。</p>
...
$install_phrases['cookiepath'] = '<b>Cookie 保存路径</b> <dfn>Cookie 保存的路径。如果您在同一个域名下运行了多个论坛，便需要将它设置为每个论坛所在的目录名。否则，填写 / 便可以了。<br /><br />Cookie 路径建议的有效值已在旁边的下拉框中列出。如果您认为还有更加合适的不同的设置，选中复选框并在下面的输入框中输入合适的值。<br /><br />请注意路径<b>总是</b>应当以正斜杠结尾，例如 \'/forums/\'、\'/vbulletin/\' 等。<br /><br /><span class="col-c">输入错误的路径，会导致您无法登录论坛。</span></dfn>';
$install_phrases['cookiedomain'] = '<b>Cookie 作用域名</b> <dfn>Cookie 所影响的域名。修改此选项默认值最常见的原因是，您的论坛有两个不同的网址，例如 example.com 和 forums.example.com。要使用户在以两个不同的域名访问论坛时，都能保持登录状态，您需要将此选项设置为 <b>.example.com</b> (注意域名需要以<b>点</b>开头)。<br /><br />Cookie 域名建议的有效值已在旁边的下拉框中列出。如果您认为还有更加合适的不同的设置，选中复选框并在下面的输入框中输入合适的值。<br /><br /><span class="col-c">若您没有把握，最好在这里什么也不填写，因为错误的设置会导致您无法登录论坛。</span></dfn>';
