...
$authenticate_phrases['cust_num_explanation'] = '这是您登录 vBulletin.com 会员区使用的客户号';
...
# upgradecore phrases
#####################################
$upgradecore_phrases['vb3_upgrade_system'] = 'vBulletin 3.6 中文版升级系统';
...
$upgradecore_phrases['php_version_too_old'] = 'vBulletin 3.6 需要 PHP 版本 4.3.3 或更高版本。您的 PHP 版本是 ' . PHP_VERSION . '，请联系主机商升级。';
$upgradecore_phrases['mysql_version_too_old'] = 'vBulletin 3.6 需要 MySQL 版本 4.0.16 或更高版本。您的 MySQL 版本是 %1$s，请联系主机商升级。';
...
$upgradecore_phrases['backup_after_upgrade'] = '<p class="smallfont">在执行升级前必须进行备份，如果升级完成请使用管理面板。</p>
		...
		要了解更多信息，请<a href="http://www.vbulletin.com/manual/html/manual_database_backup" target="_blank">阅读这里</a>。</p>';
$upgradecode_phrases['vb_database_backup_system'] = 'vBulletin 数据库备份系统';
$upgradecode_phrases['eaccelerator_too_old'] = 'eAccelerator for PHP 必须升级到 0.9.3 或更高版本。请浏览<a href="http://www.vbulletin.com/forum/showthread.php?p=979044#post979044">这个帖子</a>以了解更多信息。';
...
$upgradecode_phrases['mmcache_not_supported'] = 'Turck MMCache 已经被 eAcclerator 取代，不能正确支持 vBulletin。请浏览<a href="http://www.vbulletin.com/forum/showthread.php?p=979044#post979044">这个帖子</a>以了解更多信息。';
...
$upgrade_phrases['upgrade_300b3.php']['welcome'] = '<p style="font-size:14px;"><b>欢迎使用 vBulletin 3.6 中文版</b></p>
