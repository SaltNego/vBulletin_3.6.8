...
define('CVS_REVISION', '$RCSfile$ - $Revision: 17706 $');
...
if ($_REQUEST['do'] == 'productadd' OR $_REQUEST['do'] == 'productedit')
{
	...
	print_input_row($vbphrase['title'], 'title', $product['title'], true, 70);
...
if ($_POST['do'] == 'productimport')
{
	...
	$info = array(
		'productid'       => substr(preg_replace('#[^a-z0-9_]#i', '', $arr['productid']), 0, 25),
		'title'           => $arr['title'],
